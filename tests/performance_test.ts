...
Deno.test(
  "Performance - getExistingIds is faster than full materialize",
  testOptions,
  async () => {
...
Deno.test(
  "Performance - indexed queries are correct",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Performance - indexed queries maintain correctness with large dataset",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
