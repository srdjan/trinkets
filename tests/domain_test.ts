...
Deno.test(
  "Domain - createIssue creates issue with required fields",
  testOptions,
  async () => {
...
Deno.test(
  "Domain - createIssue creates issue with all optional fields",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - createIssue prevents duplicate IDs",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - createIssue uses getExistingIds optimization",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - addLink creates link between issues",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - patchIssue updates multiple fields",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - validateInvariants accepts healthy state",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - validateInvariants detects cycles",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - initRepo creates empty repository",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
...
Deno.test(
  "Domain - multiple operations maintain consistency",
  testOptions,
  async () => {
    const tempDir = await Deno.makeTempDir();
    try {
